## usb_cam (jazzy) - 0.8.1-1

The packages in the `usb_cam` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --track jazzy usb_cam` on `Thu, 02 May 2024 14:25:31 -0000`
...
## usb_cam (humble) - 0.8.1-1

The packages in the `usb_cam` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble usb_cam` on `Wed, 01 May 2024 17:04:41 -0000`
...
## usb_cam (iron) - 0.8.1-1

The packages in the `usb_cam` repository were released into the `iron` distro by running `/usr/bin/bloom-release --ros-distro iron --track iron usb_cam` on `Wed, 01 May 2024 17:00:36 -0000`
...
## usb_cam (rolling) - 0.8.0-2

The packages in the `usb_cam` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling usb_cam` on `Wed, 06 Mar 2024 16:37:23 -0000`
...
## usb_cam (humble) - 0.8.0-1

The packages in the `usb_cam` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble usb_cam` on `Tue, 05 Dec 2023 04:57:23 -0000`
...
## usb_cam (iron) - 0.8.0-1

The packages in the `usb_cam` repository were released into the `iron` distro by running `/usr/bin/bloom-release --ros-distro iron --track iron usb_cam` on `Tue, 05 Dec 2023 04:53:18 -0000`
